...
def ResliceMaskToMRIVoxelSpace():
    ...
    rootFolder = "D:\\OneDrive - University of Bergen\\Datasets\\MS_Longitudinal\\"
    listOfSubjects = ["Subject1"]
    modalities = ["T1", "T2"]
    dataCount = 81
    ...
    for subject in listOfSubjects:
        for modality in modalities:
            for i in range(dataCount):
                connectedComponentMaskFile = rootFolder + subject + "\\lesionMask\\Consensus" + str(i) + ".nii"
                T1VolumeFile = rootFolder + subject + "\\structural\\" + modality + ".nii"
                voxelSpaceCorrectedFile = rootFolder + subject + "\\lesionMask\\Consensus"+modality+"VoxelSpaceCorrected" + str(i) + ".nii"
